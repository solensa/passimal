  ...
  if (passwordInput.value === '') {
    ...
    for (i=1;i<passwordInput.value.length;i++){
      ...
      if (!isNaN(prevChar) && !isNaN(currChar) && !foundRecurringNumber){
        ...
        if ((numbers.includes(combinedChars) || revNumbers.includes(combinedChars)) && !foundConsecutiveNumber){
          passwordPoints = passwordPoints - 1;
...
function openInNewTab() {
  ...
  if (hiveImg == 10) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386005&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 11) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386007&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 12) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386008&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 13) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386078&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 14) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386079&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 15) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386080&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 16) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386121&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 17) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386122&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 0) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386124&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 1) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386125&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 2) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386126&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 3) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386127&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 4) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386128&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 5) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386129&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 6) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386130&containerType=700&containerID=81680&conversionType=DISCUSSION";
  } else if (hiveImg == 7) {
    url = "https://hive.intranet.group//createacopy/create.jspa?documentID=386151&containerType=700&containerID=81680&conversionType=DISCUSSION";
  }

  if (foundWeakPassword){
    if (showPokemon){
      url = "https://hive.intranet.group//createacopy/create.jspa?documentID=417598&containerType=700&containerID=81680&conversionType=DISCUSSION";
    } else {
      url = "https://hive.intranet.group//createacopy/create.jspa?documentID=417599&containerType=700&containerID=81680&conversionType=DISCUSSION";
    }
  }
